      ...
      <GlobalTheme theme={theme}>
        <div className="v0plex-content">
          <div className="page-typography-content">
            ...
            <PageDates
              publishedAt="July 20th 2025"
              updatedAt="August 2nd 2025"
            />
                ...
                <UnorderedList isExpressive={false}>
                  ...
                  <ListItem>
                    ...
                    <UnorderedList nested>
                      ...
                      <ListItem>可以嵌入JSX元素。有些特制的元素不是Vanilla JS，而是默认就提供React
                        JSX或者TSX，这一点Hexo和Hugo是不支持的，用户在使用md或者mdx的同时就牺牲了自由度</ListItem>
                    </UnorderedList>
                  </ListItem>
            ...
            <p>
              <>总之，强自由度就会更少依赖于某一框架，总体来讲，得益于这个时代有AI工具加持，能实现开发者心中很多原本虚无缥缈的Idea，通过v0.dev的神力，我上述的需求不再是Idea，而是已经实现了的现实。下一篇Blog会详细介绍v0.dev如何快速的帮我Fast
                Prototype。
              </>
            </p>
          </div>
