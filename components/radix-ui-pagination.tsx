...
import {ButtonProps, buttonVariants} from "@/components/radix-button"

const RadixUiPagination = ({className, ...props}: React.ComponentProps<"nav">) => (
  <nav
    role="navigation"
...
RadixUiPagination.displayName = "RadixUiPagination"
